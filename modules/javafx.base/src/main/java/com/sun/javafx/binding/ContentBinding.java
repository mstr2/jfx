...
public class ContentBinding {
    ...
    private static class ListContentBinding<E>
            extends ContentBinding implements ListChangeListener<E>, WeakListener {
        ...
        public void onChanged(Change<? extends E> change) {
            ...
            final List<E> list = list1.get();

            if (change.getList() == list) {
    ...
    private static class SetContentBinding<E>
            extends ContentBinding implements SetChangeListener<E>, WeakListener {
        ...
        public void onChanged(Change<? extends E> change) {
            ...
            final Set<E> set = this.set1.get();

            if (change.getSet() == set) {
    ...
    private static class MapContentBinding<K, V>
            extends ContentBinding implements MapChangeListener<K, V>, WeakListener {
        ...
        public void onChanged(Change<? extends K, ? extends V> change) {
            final Map<K, V> map = this.map1.get();

            if (change.getMap() == map) {
                Map<K, V> map1 = this.map1.get();
                if (map1 instanceof ObservableList<?>) {
