...
public abstract class Application {
    ...
    public static class EventHandler {
        ...
        public void handlePreferencesChanged(Map<String, Object> preferences, boolean expectMoreChanges) {
        }
    }
    ...
    protected void notifyPreferencesChanged(Map<String, Object> preferences, boolean waitHint) {
        EventHandler handler = getEventHandler();
        if (handler != null) {
            handler.handlePreferencesChanged(preferences, waitHint);
        }
    }
