...
public final class CurlyBlock extends AbstractList<ComponentValue> implements SimpleBlock {
    ...
    public CurlyBlock(List<ComponentValue> values, int line, int column) {
    ...
    public boolean equals(Object obj) {
        return obj instanceof CurlyBlock block
            && block.hash == hash
