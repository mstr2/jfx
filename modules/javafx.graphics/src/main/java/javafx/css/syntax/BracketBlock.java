...
public final class BracketBlock extends AbstractList<ComponentValue> implements SimpleBlock {
    ...
    public BracketBlock(List<ComponentValue> values, int line, int column) {
    ...
    public boolean equals(Object obj) {
        return obj instanceof BracketBlock block
            && block.hash == hash
