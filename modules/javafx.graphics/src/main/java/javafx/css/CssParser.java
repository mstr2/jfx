...
final public class CssParser {
    ...
    // Specifies whether conditional imports with unmatchable conditions (i.e. conditions that always
    // evaluate to false) should be imported. For serialization purposes, this flag is set so that
    // the complete stylesheet with all of its imports is retained in the serialized form.
    private boolean importUnmatchableStylesheets;
     ...
     */
    Stylesheet parseUnmerged(String stylesheetText, boolean importUnmatchableStylesheets) {
        this.importUnmatchableStylesheets = importUnmatchableStylesheets;
    ...
    public Stylesheet parse(final String docbase, final String stylesheetText) throws IOException {
        importUnmatchableStylesheets = false;
     ...
     * for serialization purposes. At runtime, all imported stylesheets must be merged into the main stylesheet.
     */
    Stylesheet parseUnmerged(URL url, boolean importUnmatchableStylesheets) throws IOException {
        this.importUnmatchableStylesheets = importUnmatchableStylesheets;
...
//                continue;
    ...
    private StylesheetImport handleImport(CssLexer lexer) {
        ...
        if (!importUnmatchableStylesheets && importConditions.evaluate() == TriState.FALSE) {
            return null;
        }
