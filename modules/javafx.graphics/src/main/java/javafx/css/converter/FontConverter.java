 ...
 * @since 9
 */
public final class FontConverter extends StyleConverter<Font> {

    private static final FontConverter instance = new FontConverter();
    ...
    @Override
    public Font convert(Block value, Font font) {
        return null;
    }
}
