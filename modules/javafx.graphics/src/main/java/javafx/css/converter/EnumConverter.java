 ...
 * @since 9
 */
public final class EnumConverter<E extends Enum<E>> extends StyleConverter<E> {
    ...
    @Override
    public E convert(Block value, Font font) {
        ...
        try {
            ...
            return Enum.valueOf(convertedType(), string.toUpperCase(Locale.ROOT));
        } catch (IllegalArgumentException e) {
            // may throw another IllegalArgumentException
            return Enum.valueOf(convertedType(), string);
        }
    }
}
