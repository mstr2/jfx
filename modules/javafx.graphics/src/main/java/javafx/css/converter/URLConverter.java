 ...
 * @since 9
 */
public final class URLConverter extends StyleConverter<URL> {

    private static final URLConverter instance = new URLConverter();
    ...
    @Override
    public URL convert(Block values, Font font) {
        return null;
    }
}
