 ...
 * @since 9
 */
public final class PaintConverter extends StyleConverter<Paint> {

    private static final PaintConverter instance = new PaintConverter();
    ...
    @Override
    public Paint convert(Block value, Font font) {
        return null;
    }
}
