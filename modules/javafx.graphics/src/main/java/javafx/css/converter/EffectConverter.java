 ...
 * @since 9
 */
public final class EffectConverter extends StyleConverter<Effect> {

    private static final EffectConverter instance = new EffectConverter();
    ...
    @Override
    public Effect convert(Block value, Font font) {
        return null;
    }
}
