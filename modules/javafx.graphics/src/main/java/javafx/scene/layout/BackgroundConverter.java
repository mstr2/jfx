 ...
 */
class BackgroundConverter extends StyleConverter<Background> implements StyleCompositor<Background> {

    private static final BackgroundConverter instance = new BackgroundConverter();
    ...
    @Override
    public Background convert(Block value, Font font) {
        return null;
    }

    @Override
    public Background compose(Map<CssMetaData<? extends Styleable, ?>, Object> convertedValues) {
        return null;
    }

    @Override
    public Map<CssMetaData<? extends Styleable, ?>, Object> decompose(Background value) {
        return Map.of();
    }
}
