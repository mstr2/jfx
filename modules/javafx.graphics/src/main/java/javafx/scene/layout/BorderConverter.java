...
/**
 */
final class BorderConverter extends StyleConverter<Border> implements StyleCompositor<Border> {

    private static final BorderConverter instance = new BorderConverter();
    ...
    @Override
    public Border convert(Block value, Font font) {
        return null;
    }

    @Override
    public Border compose(Map<CssMetaData<? extends Styleable, ?>, Object> convertedValues) {
        return null;
    }

    @Override
    public Map<CssMetaData<? extends Styleable, ?>, Object> decompose(Border value) {
        return Map.of();
    }
}
